...
#' @param ref_seq String indicating the reference sequence used in the experimenti. Default is '',
#' @param ref_flank_left String indicating the first nucleotides of the reference sequence that never mutate over the
#' course of the experiment. Default is "",
...
#' @param ref_cut_sites Positions in the reference sequence of the cutting sites. Default is c(),
#' @param ref_border_sites c().
